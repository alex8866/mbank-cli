...
=item *
B<mbank-cli> B<activate-profile> [I<option>...] {B<personal> | B<business>}
...
I<[account-name]> I<[id]> I<date> I<accounting-date> I<amount> I<balance> I<description>
...
Syntax:
B<mbank-cli> B<activate-profile> {B<personal> | B<business>}

Activate the personal profile, or the business profile.

This is an experimental command.
It is provided only a stop-gap solution
...
=head2 Session cookie store (a.k.a. cookie jar)
...
The “B<configure>” command uses B</etc/timezone> to guess the user's country.
